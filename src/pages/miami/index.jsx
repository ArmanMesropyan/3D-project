        ...
        return (
            <div className='L-main-miami'>
                <div className="L-description">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus, ex explicabo iusto laboriosam
                        molestiae saepe unde. Corporis ex fugit molestias odio possimus, quibusdam voluptas voluptate! Ipsam
                        libero numquam sit. Commodi.</p>
                </div>
                <div className='L-miami' style={{zIndex: 10}}>
                    <div className="rotate" style={{zIndex: 10}}>
                        <Swiper  {...swiperParams} modules={[Controller]}
                ...
                <div className='L-slider-bg L-miami' style={{zIndex: 1}}>
                    <div className="rotate" style={{zIndex: 1}}>
                        <Swiper  {...swiperBgParams} modules={[Controller]}
